...
def run_experiment(task_cpu, repeat):
    params.min_cpu = task_cpu - 0.1
    params.max_cpu = task_cpu + 0.1
    # 결과 저장 딕셔너리 초기화
...
def plot(results, task_cpu_range):
    ...
    # 성공률 플롯
    ax1.plot(task_cpu_range, results['our_succ'], label="Proposed", color='purple', linestyle='-', linewidth=2, marker='D')
    ax1.plot(task_cpu_range, results['woCloud_succ'], label="Without Cloud", color='purple', linestyle='--', linewidth=2, marker='D')
    ax1.plot(task_cpu_range, results['LF_succ'], label="Local First", color='blue', linestyle='--', linewidth=2, marker='o')
    ax1.plot(task_cpu_range, results['LFCloud_succ'], label="Local First Cloud", color='blue', linestyle='-', linewidth=2, marker='o')
    ax1.plot(task_cpu_range, results['Greedy1_succ'], label="Greedy(1-hop)", color='green', linestyle='--', linewidth=2, marker='s')
    ax1.plot(task_cpu_range, results['Greedy1Cloud_succ'], label="Greedy Cloud(1-hop)", color='green', linestyle='-', linewidth=2, marker='s')
    ax1.plot(task_cpu_range, results['Greedy2_succ'], label="Greedy(2-hop)", color='red', linestyle='--', linewidth=2, marker='^')
    ax1.plot(task_cpu_range, results['Greedy2Cloud_succ'], label="Greedy Cloud(2-hop)", color='red', linestyle='-', linewidth=2, marker='^')

    ax1.set_xlabel('Required Computing Resource', fontsize=font_size + 10)
    ...
    # 리워드 플롯
    ax2.plot(task_cpu_range, results['our_reward'], label="Proposed", color='purple', linestyle='-', linewidth=2, marker='D')
    ax2.plot(task_cpu_range, results['woCloud_reward'], label="Without Cloud", color='purple', linestyle='--', linewidth=2, marker='D')
    ax2.plot(task_cpu_range, results['LF_reward'], label="Local First", color='blue', linestyle='--', linewidth=2, marker='o')
    ax2.plot(task_cpu_range, results['LFCloud_reward'], label="Local First Cloud", color='blue', linestyle='-', linewidth=2, marker='o')
    ax2.plot(task_cpu_range, results['Greedy1_reward'], label="Greedy(1-hop)", color='green', linestyle='--', linewidth=2, marker='s')
    ax2.plot(task_cpu_range, results['Greedy1Cloud_reward'], label="Greedy Cloud(1-hop)", color='green', linestyle='-', linewidth=2, marker='s')
    ax2.plot(task_cpu_range, results['Greedy2_reward'], label="Greedy(2-hop)", color='red', linestyle='--', linewidth=2, marker='^')
    ax2.plot(task_cpu_range, results['Greedy2Cloud_reward'], label="Greedy Cloud(2-hop)", color='red', linestyle='-', linewidth=2, marker='^')

    ax2.set_xlabel('Required Computing Resource', fontsize=font_size + 10)
...
if __name__ == '__main__':
    task_cpu_range = np.arange(1, 3.1, 0.5)
