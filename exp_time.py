...
def plot(results, time_range):
    ...
    ax1.plot(time_range, results['cloud_near_succ'], label="Nearest Cloud", linewidth=2)
    ax1.plot(time_range, results['gree_succ'], label='Greedy(1-hop)', linewidth=2)
    ax1.plot(time_range, results['cloud_gree_succ'], label="Greedy Cloud", linewidth=2)
    ...
    ax2.plot(time_range, results['cloud_near_reward'], label="Nearest Cloud", linewidth=2)
    ax2.plot(time_range, results['gree_reward'], label='Greedy(1-hop)', linewidth=2)
    ax2.plot(time_range, results['cloud_gree_reward'], label="Greedy Cloud", linewidth=2)
