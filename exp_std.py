...
def run_experiment(resource_std, repeat):
    ...
    for _ in range(repeat):
        ...
        params.resource_std = resource_std  # Update the resource standard deviation
...
def plot(results, std_range):
    ...
    ax1.plot(std_range, results['near_succ'], label='Nearest', linewidth=2)
    ax1.plot(std_range, results['gree_succ'], label='Greedy(1-hop)', linewidth=2)
    ax1.plot(std_range, results['gree2_succ'], label="Greedy(2-hop)", linewidth=2)
    ax1.plot(std_range, results['our_succ'], label="Our scheme", linewidth=2)
    ax1.plot(std_range, results['woclst_succ'], label="Without clustering", linewidth=2)
    ax1.plot(std_range, results['wocloud_succ'], label="Without cloud", linewidth=2)
    ax1.plot(std_range, results['staticclst_succ'], label="Static clustering", linewidth=2)

    ax1.set_xlabel('Resource Standard Deviation', fontsize=font_size)

    ax1.legend()
    ax1.set_ylabel('Success rate', fontsize=font_size)
    ax1.tick_params(axis='both', which='major', labelsize=font_size)

    ax2.plot(std_range, results['near_reward'], label='Nearest', linewidth=2)
    ax2.plot(std_range, results['gree_reward'], label='Greedy(1-hop)', linewidth=2)
    ax2.plot(std_range, results['gree2_reward'], label="Greedy(2-hop)", linewidth=2)
    ax2.plot(std_range, results['our_reward'], label="Our scheme", linewidth=2)
    ax2.plot(std_range, results['woclst_reward'], label="Without clustering", linewidth=2)
    ax2.plot(std_range, results['wocloud_reward'], label="Without cloud", linewidth=2)
    ax2.plot(std_range, results['staticclst_reward'], label="Static clustering", linewidth=2)

    ax2.set_xlabel('Resource Standard Deviation', fontsize=font_size)
