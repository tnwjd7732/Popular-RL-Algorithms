...
def run_experiment(task_size, repeat, env, ppo_, dqn_, ppo_woclst_, dqn_woclst_, ppo_wocloud_, dqn_wocloud_):
...
if __name__ == '__main__':
    ...
    for task_size in task_size_range:
        avg_results = run_experiment(task_size, repeat, env, ppo_, dqn_, ppo_woclst_, dqn_woclst_, ppo_wocloud_, dqn_wocloud_)
