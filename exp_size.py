...
def run_experiment(task_size, repeat, env):
    params.min_size = task_size * 8 -0.01  # Task size in bits
    params.max_size = task_size * 8 +0.01
    # 결과 저장 딕셔너리 초기화
...
def plot(results, task_size_range):
    ...
    # Success rate plot
    ax1.plot(task_size_range, results['our_succ'], label="Proposed", color='purple', linestyle='-', linewidth=2, marker='D')
    ax1.plot(task_size_range, results['wocloud_succ'], label="Proposed w/o Cloud", color='purple', linestyle='--', linewidth=2, marker='D')
    ax1.plot(task_size_range, results['LF_succ'], label="LF", color='blue', linestyle='--', linewidth=2, marker='o')
    ax1.plot(task_size_range, results['LFCloud_succ'], label="LF Cloud", color='blue', linestyle='-', linewidth=2, marker='o')
    ax1.plot(task_size_range, results['Greedy1_succ'], label="Greedy(1-hop)", color='green', linestyle='--', linewidth=2, marker='s')
    ax1.plot(task_size_range, results['Greedy1Cloud_succ'], label="Greedy Cloud(1-hop)", color='green', linestyle='-', linewidth=2, marker='s')
    ax1.plot(task_size_range, results['Greedy2_succ'], label="Greedy(2-hop)", color='red', linestyle='--', linewidth=2, marker='^')
    ax1.plot(task_size_range, results['Greedy2Cloud_succ'], label="Greedy Cloud(2-hop)", color='red', linestyle='-', linewidth=2, marker='^')
    ...
    # Reward plot
    ax2.plot(task_size_range, results['our_reward'], label="Proposed", color='purple', linestyle='-', linewidth=2, marker='D')
    ax2.plot(task_size_range, results['wocloud_reward'], label="Proposed w/o Cloud", color='purple', linestyle='--', linewidth=2, marker='D')
    ax2.plot(task_size_range, results['LF_reward'], label="LF", color='blue', linestyle='--', linewidth=2, marker='o')
    ax2.plot(task_size_range, results['LFCloud_reward'], label="LF Cloud", color='blue', linestyle='-', linewidth=2, marker='o')
    ax2.plot(task_size_range, results['Greedy1_reward'], label="Greedy(1-hop)", color='green', linestyle='--', linewidth=2, marker='s')
    ax2.plot(task_size_range, results['Greedy1Cloud_reward'], label="Greedy Cloud(1-hop)", color='green', linestyle='-', linewidth=2, marker='s')
    ax2.plot(task_size_range, results['Greedy2_reward'], label="Greedy(2-hop)", color='red', linestyle='--', linewidth=2, marker='^')
    ax2.plot(task_size_range, results['Greedy2Cloud_reward'], label="Greedy Cloud(2-hop)", color='red', linestyle='-', linewidth=2, marker='^')
...
if __name__ == '__main__':
    task_size_range = np.arange(0.1, 2.0, 0.2)
