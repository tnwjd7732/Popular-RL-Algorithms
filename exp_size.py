...
def run_experiment(task_size, repeat, env, ppo_, dqn_, ppo_wocloud_, dqn_wocloud_):
    ...
    for _ in range(repeat):
        params.task_size = task_size  # Update the task size
...
def plot(results, task_size_range):
    ...
    ax1.plot(task_size_range, results['cloud_near_succ'], label="Nearest Cloud", linewidth=2)
    ax1.plot(task_size_range, results['cloud_gree_succ'], label="Greedy Cloud", linewidth=2)
    ...
    ax2.plot(task_size_range, results['cloud_near_reward'], label="Nearest Cloud", linewidth=2)
    ax2.plot(task_size_range, results['cloud_gree_reward'], label="Greedy Cloud", linewidth=2)
